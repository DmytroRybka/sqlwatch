...
import sqlwatch4.driverlistener.SqlWatch4SpyLogDelegator;
...
public class SpyLogFactory
{
   ...
   */
  private static final SpyLogDelegator logger = new SqlWatch4SpyLogDelegator(); //TODO single edited line [dmitry.mamonov].
